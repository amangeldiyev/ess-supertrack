                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <label class="custom-control custom-radio">
                                                <input type="radio" name="passenger_type" value="0" {{isset($taxiRequest) && $taxiRequest->passenger_type == 0 ?  "checked" : ""}} class="custom-control-input"><span class="custom-control-label">Client</span>
                                            </label>
                                            <label class="custom-control custom-radio">
